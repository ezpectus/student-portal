...
start "Student Portal - Info" cmd /k "cd /d ""%ROOT%"" && echo Student Portal local stack && echo. && echo Frontend: http://localhost:3000 && echo Prisma Studio: http://localhost:5555 && echo Test users: admin, teacher, student / test12345 && echo. && echo Close this window or press Ctrl+C in each log window to stop services && pause"
